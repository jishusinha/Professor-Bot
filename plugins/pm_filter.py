...
async def pm_next_page(bot, query):
    ...
    btn.insert(0, [InlineKeyboardButton("🔗 Hᴏᴡ Tᴏ Dᴏᴡɴʟᴏᴀᴅ 🔗", url="https://t.me/MadflixBots_Support/9")])
...
async def pm_AutoFilter(client, msg, pmspoll=False):    
    ...
    if offset != "":
        ...
        btn.append(
            ...
            InlineKeyboardButton(text="Nᴇxᴛ ➡️", callback_data=f"pmnext_{req}_{key}_{offset}")]
        )
    else:
        btn.append(
